...
export  const ascii_rose = <div className = "ascii_graphics" style = {{fontSize:'6px',margin:'auto',paddingTop:'20px',color:'#ff00ff'}}>{` ._-\\                           +....                                                 
...
/_#^ /  \\........_                .   : \"           ,^....                            
 ...
 ^   |/          .+     .  , \\.............------/                                    
               ._     _/         ,                                                    
              ,x..._;^                                                                `}</div>
export  const ascii_rocket = <div className = "ascii_graphics" style = {{fontSize:'6px',margin:'auto',paddingTop:'20px',color:'#ff00ff'}}>
{`                                 /--/+---------      .    ..                          
                                |  | ........ /    \`\`\`..........                      
